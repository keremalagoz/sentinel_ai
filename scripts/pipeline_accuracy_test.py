...
TEST_CASES: List[PipelineTestCase] = [
    ...
    PipelineTestCase(
        ...
        must_contain=["nmap", "--script", "ssl-enum-ciphers", "example.com"],
        expected_executable="nmap", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        params={"port": "8443"},
        must_contain=["nmap", "--script", "ssl-enum-ciphers", "-p", "8443", "secure.example.com"],
        expected_executable="nmap", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nmap", "--script", "ssl-enum-ciphers", "mysite.com"],
        expected_executable="nmap", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nmap", "--script", "ssl-enum-ciphers", "mail.example.com"],
        expected_executable="nmap", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nmap", "--script", "ssl-enum-ciphers", "cdn.example.com"],
        expected_executable="nmap", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nikto", "-h", "http://target.com"],
        expected_executable="nikto", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nikto", "-h", "https://secure.target.com"],
        expected_executable="nikto", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nikto", "-h", "http://192.168.1.100"],
        expected_executable="nikto", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nikto", "-h", "http://10.0.0.1:8080"],
        expected_executable="nikto", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["nikto", "-h", "http://api.target.com"],
        expected_executable="nikto", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["hydra", "-l", "admin", "-P", "/usr/share/wordlists/rockyou.txt", "192.168.1.100", "ssh"],
    ...
    PipelineTestCase(
        ...
        must_contain=["hydra", "-l", "root", "-P", "-s", "2222", "10.0.0.5", "ssh"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["hydra", "-l", "user", "-P", "/tmp/passwords.txt", "-t", "16", "172.16.0.1", "ssh"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["hydra", "-l", "admin", "-P", "-v", "192.168.0.50", "ssh"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["hydra", "-l", "test", "-P", "/opt/wordlist.txt", "-s", "22", "-t", "8", "-v", "10.10.10.10", "ssh"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        params={"username": "admin", "wordlist": "/usr/share/wordlists/rockyou.txt",
                ...
                "fail_string": "Invalid"},
        must_contain=["hydra", "-l", "admin", "-P", "192.168.1.1", "http-post-form"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["hydra", "-l", "admin", "-P", "-s", "8080", "10.0.0.1", "http-post-form"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        must_contain=["hydra", "-l", "user", "-P", "/tmp/pass.txt", "-t", "32", "192.168.2.1", "http-post-form"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        params={"username": "admin", "wordlist": "/usr/share/wordlists/rockyou.txt",
                ...
                "fail_string": "denied", "method": "GET"},
        must_contain=["hydra", "-l", "admin", "-P", "10.0.0.5", "http-get-form"],
        expected_executable="hydra", expected_requires_root=False,
    ...
    PipelineTestCase(
        ...
        params={"username": "root", "wordlist": "/usr/share/wordlists/rockyou.txt",
                "form_path": "/login", "form_params": "u=^USER^&p=^PASS^",
                "fail_string": "wrong"},
        must_contain=["hydra", "-l", "root", "-P", "target.local", "http-post-form"],
        expected_executable="hydra", expected_requires_root=False,
